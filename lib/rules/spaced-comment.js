...
module.exports = function(context) {
    ...
    function isJsdoc(node) {
        // make sure comment is multi-line and it start with /**\n
        return node.loc.end.line > node.loc.start.line && jsDocMatcher.test(node.value);
    }
    ...
    function checkCommentForSpace(node) {
        ...
        if (requireSpace) {
            ...
            if (node.type === "Block" && isJsdoc(node)) {
                return;
            }
